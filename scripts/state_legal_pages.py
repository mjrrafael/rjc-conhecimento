...
UPDATED_ON = os.environ.get("RJC_STATE_LEGAL_UPDATED_ON", "26/06/2026")
...
CURATED_CATEGORY_BY_SOURCE_ID = {
    ...
    "DF_LC_1068_2026_DEVEDOR_CONTUMAZ": "ICMS_LEIS",
...
DF_CHAPTERS = [
    ...
    },
    {
        ...
        "refs": [
            ...
            {"source": "DF_LC_1068_2026_DEVEDOR_CONTUMAZ", "articles": ["2", "3", "4", "6"]},
...
STANDARD_STATE_SOURCE_SETS = {
    "SP": {
        ...
        "st_sources": ["SP_RICMS_2000_INTEGRAL", "SP_PORTARIA_SRE_24_2026_IVA_ST_ELETRONICOS"],
